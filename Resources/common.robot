...
Test App Android
    [Tags]  Android
     Open Application    ${appium_host}                 platformName=${platform_name_andr}
     ...  deviceName=@{deviceName_andr}[0]              platformVersion=@{platformVersion_andr}[0]
     ...  noReset=${noreset_andr}                       automationName=${automationName_andr}
     ...  appPackage=${appPackage}                      appActivity=${appActivity}                      #app=${app}
