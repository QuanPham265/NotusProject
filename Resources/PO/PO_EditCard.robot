...
Get Bank Customer Identify Card - Text
    ${customer_identify_card} =  get text  ${ID_EditCard_CustomerID}
    [Return]  ${customer_identify_card}

Get Bank Customer Identify Card - State Edit    #true: can edit, false: block edit
    ${state_enabled_edit} =  get element attribute  ${ID_EditCard_CustomerID}  enabled
    [Return]  ${state_enabled_edit}

Get Bank Customer Identify Card - State Display     #true: display, false: hidden
